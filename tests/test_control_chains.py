...
with sync_playwright() as p:
    ...
    try:
        ...
        check("release-version-and-schema", page.evaluate("[__SENTINEL_TEST__.appVersion,__SENTINEL_TEST__.schemaVersion]") == ["0.13.5", 13])
        ...
        mobile.wait_for_function("window.__SENTINEL_TEST__ && window.__SENTINEL_TEST__.schemaVersion===13")
