"""SENTINEL v0.15.0-rc.2 shell consolidation, workflow, and responsive layout checks."""
...
with sync_playwright() as p:
    ...
    try:
        ...
        check("cleanup-release-version", page.evaluate("__SENTINEL_TEST__.appVersion") == "0.15.0-rc.2")
