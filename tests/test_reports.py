...
with sync_playwright() as p:
    ...
    try:
        ...
        check("html-report-version", "SENTINEL v0.15.0-rc.2" in report_html and "Schema 14" in report_html)
        ...
        check("markdown-version-footer", "SENTINEL v0.15.0-rc.2" in markdown and "Project Schema 14" in markdown)
