...
with sync_playwright() as p:
    ...
    try:
        ...
        check("application-version", "v0.13.5" in page.locator(".topbar .brand small").inner_text(), page.locator(".topbar .brand small").inner_text())
        ...
        check("test-interface", hook["v"] == "0.13.5" and hook["s"] == 13, hook)
